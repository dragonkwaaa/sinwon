				...
				<div class="conGroup verticalManageSort bottomRowSort">
					...
					<table class="searchResultTable ">
                        ...
                        <tr>
							...
							<td>
								<input class="tbox regFullSort priceMod onlyNum" value="1122">
							</td>
							<td>
                                <input class="tbox regFullSort listMod" value="인건비(급여)">
							</td>
							<td>
							...
							<td>
                                <input class="tbox regFullSort priceMod onlyNum" value="1,000,000">
								<span>원</span>
							</td>
							<td>
                                <input class="tbox regFullSort listMod" value="국민은1">
							</td>
							<td>
