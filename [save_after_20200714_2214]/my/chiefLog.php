	...
	<div class="wrapper">
		<div class="contents">
			<div class="section horizontalManageSort searcManageSort topLineMod">
				<div class="titleBox manageHeadlineSort">내역검색</div>
								...
								<td>
									<span class="sbox">
										...
										<ul>
											...
											<li><a href="javascript:void(0);">부서명</a></li>
											<li><a href="javascript:void(0);">직원명</a></li>
										</ul>
									</span>
				...
				<div class="conGroup verticalManageSort specSearchHiddenMod hide">
					<table class="searchGroup">
						<colgroup>
							<col width="70">
							<col width="*">
							...
							<tr>
								...
								<td>
									<div class="dateInputCase regFullSort">
										<input class="tbox dateBox shortMod" id="registeredDate" readonly="" placeholder="등록일">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="dateInputCase regFullSort">
										<input class="tbox dateBox shortMod" id="enterDate" readonly="" placeholder="입사일">
									</div>
								</td>
							</tr>
							<tr>
								<th>상세 검색어</th>
								<td>
									<input class="tbox searchInput mt7" placeholder="검색어를 입력해주세요.">
								</td>
							</tr>
						</tbody>
					</table>
				...
				<div class="btnGroup verticalBottomSort">
					<a href="javascript:void(0);" class="btn specSearchShowMod">상세검색 ▼</a>
					<a href="javascript:void(0);" class="btn specSearchHideMod hide">상세검색 닫기 ▲</a>
				</div>
				<div class="btnGroup verticalBottomSort">
					...
					<table class="infoGroup">
						...
						<tbody>
							...
							<tr>
								<th>직원코드</th>
								<td>
									<input class="tbox regFullSort" value="1144" readonly>
								</td>
							</tr>
							<tr>
								<th>이름</th>
								<td>
									<input class="tbox regFullSort" value="곽반장" readonly>
								</td>
							</tr>
							<tr>
								<th>부서</th>
							...
							<tr>
								<th>제목</th>
								<td>
									<input class="tbox regFullSort" value="관리권한 변경" readonly>
								</td>
							</tr>
							<tr>
								<th>상세내용</th>
								<td>
									<textarea class="tarea regFullSort" readonly>관리 권한 확대. (수입관리, 지출관리 개방)</textarea>
								</td>
							</tr>
						</tbody>
					</table>
